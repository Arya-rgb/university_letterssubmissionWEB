...
<html>
  <head>
    ...
    <script src="<?php echo base_url('assets/js/util.min.js'); ?>">
    </script>
    <script src="<?php echo base_url('assets/js/carousel.min.js'); ?>">
    </script>
    <script src="<?php echo base_url('assets/js/js.euy.min.js'); ?>">
    </script>
    <script src="<?php echo base_url('assets/js/jscuy15.min.js'); ?>">
    </script>
    <script>
      $(document).ready(function()
        ...
        $("a[href*='#services']").click(function(event)
          ...
          $('html, body').stop().animate({
            scrollTop: $('#wb_services').offset().top-80 }
                                         , 600, 'linear');
        }
                                       );
        ...
        <div class="row">
          <div class="col-1">
            <div id="wb_Heading3" style="display:inline-block;width:100%;z-index:0;">
              <h1 id="Heading3">SELAMAT DATANG
              </h1>
            </div>
            <div id="wb_Text3">
              <span style="color:#A0A0A0;font-family:Arial;font-size:16px;">
                <em>Di sini mahasiswa dapat mengajukan surat pengantar dan surat keterangan kepada lembaga. Pengajuan akan di cek langsung oleh admin dan akan di beritahu lewat email jika surat nya suda siap. 
                </em>
              </span>
            </div>
            <div id="wb_Shape2" style="display:inline-block;width:132px;height:40px;z-index:2;position:relative;">
              <a href="http://localhost/miniproject/index.php/ajuan/login_admin">
                <div id="Shape2">
                  <div id="Shape2_text">
                    <span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Login Admin
                    </span>
                  </div>
                </div>
              </a>
          ...
          <div class="carousel-item active">
            <div class="carousel-innerframe">
              <div id="wb_Image2" style="display:inline-block;width:943px;height:628px;z-index:4;">
                <img src=
                     <?php echo base_url('assets/images/t1.jpg'); ?> id="Image2" alt="">
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="carousel-innerframe">
              <div id="wb_Image3" style="display:inline-block;width:945px;height:628px;z-index:5;">
                <img src=
                     <?php echo base_url('assets/images/t2.jpg'); ?> id="Image3" alt="">
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <div class="carousel-innerframe">
              <div id="wb_Image4" style="display:inline-block;width:946px;height:628px;z-index:6;">
                <img src=
                     <?php echo base_url('assets/images/t3.jpg'); ?> id="Image4" alt="">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-1">
            <div id="wb_service1">
              ...
              <span style="color:#FFFFFF;font-family:Arial;font-size:13px;">
                <br>
                <br>Dalam Form ini anda harus daftarkan nim dan nama anda untuk login nanti dalam proses download surat.
              </span>
            </div>
          </div>
          <div class="col-2">
            <div id="wb_service2">
              ...
              <span style="color:#FFFFFF;font-family:Arial;font-size:13px;">
                <br>Dalam Form ini anda harus login dengan akun yang terdaftar lalu anda dapat cek status surat, jika tersedia bisa di unduh.
              </span>
            </div>
          </div>
          <div class="col-3">
            <div id="wb_service3">
              ...
              <span style="color:#FFFFFF;font-family:Arial;font-size:13px;">
                <br>
                <br>Dalam Form ini anda dapat mendownload formulir yang berlaku di institusi untuk keperluan pribadi maupun akademik.
              </span>
            </div>
          </div>
        </div>
    ...
    <div id="wb_LayoutGrid6">
      <div id="LayoutGrid6">
        <div class="row">
          <div class="col-1">
            <div id="wb_Text6">
              <span style="color:#9C9C9C;font-family:Arial;font-size:15px;">
                <strong>ADDRESS
                </strong>
                <br>Jl. Cikutra No.113, Cikutra, Kec. Cibeunying Kidul, Kota Bandung, Jawa Barat 40124
                <br>
                <br>
                <strong>CONTACTS
                </strong>
                <br>Web : stmik-bandung.ac.id
                <br>Phone: (022) 7207777
                <br>
              </span>
            </div>
          </div>
          <div class="col-2">
            <div id="wb_Image5" style="display:inline-block;width:100%;height:auto;z-index:11;">
              <a href="https://goo.gl/maps/pn1UeHJLPiyS1f1s5">
                <img src=
                     <?php echo base_url('assets/images/maps_cannes.png'); ?> id="Image5" alt="">
              </a>
            </div>
          </div>
        </div>
