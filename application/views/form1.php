...
<a href="http://www.stmik-bandung.ac.id/stmikbdg/"><div id="FontAwesomeIcon1"><i class="fa fa-check"></i></div></a>
</div>
</div>
<div class="col-2">
...
<a href="https://web.facebook.com/BandungSTMIK/"><div id="FontAwesomeIcon3"><i class="fa fa-facebook"></i></div></a>
</div>
<div id="wb_FontAwesomeIcon4" style="display:inline-block;width:20px;height:20px;text-align:center;z-index:14;">
<a href="www.instagram.com/stmikbandung/"><div id="FontAwesomeIcon4"><i class="fa fa-instagram"></i></div></a>
</div>
<div id="wb_FontAwesomeIcon8" style="display:inline-block;width:20px;height:20px;text-align:center;z-index:15;">
<a href="https://www.youtube.com/channel/UCquRaRrD-VR2sWhHNHDLV5g"><div id="FontAwesomeIcon8"><i class="fa fa-youtube"></i></div></a>
</div>
<div id="wb_FontAwesomeIcon10" style="display:inline-block;width:20px;height:20px;text-align:center;z-index:16;">
<a href="mailto:info@stmik-bandung.ac.id"><div id="FontAwesomeIcon10"><i class="fa fa-volume-control-phone"></i></div></a>
</div>
</div>
<div class="col-3">
</div>
